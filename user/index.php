...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  ...
  <title>Landing Course | Geeks - Bootstrap 5 Template </title>
</head>
	...
	<div class="container-fluid px-0">
		...
		<div class="collapse navbar-collapse" id="navbar-default">
			...
			<div class="ms-auto mt-3 mt-lg-0">
				<a href="../login.php" class="btn btn-white shadow-sm me-1">Sign In</a>
  ...
  <div class="py-lg-18 py-10 bg-auto" style="background: url(../../assets/images/hero/hero-graphics.svg)no-repeat , linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #FFFFFF 100%), rgba(221, 218, 255, 0.3) ; background-size: cover; background-position: top center">
          ...
          <div class="py-8 py-lg-0 text-center">
            ...
            <div class="mt-8 mb-0">
              <ul class="list-inline">
                <li class="list-inline-item text-dark fw-semi-bold lh-1 fs-4 me-3   mb-2 mb-md-0"><span class="icon-shape icon-xs rounded-circle bg-light-success text-center me-2"><i class="mdi mdi-check text-success "></i></span><span class="align-middle">30,000 online courses</span></li>
    ...
    <div class="row mb-6 justify-content-center">
      ...
      <div class="col-lg-8 col-md-12 col-12 text-center">
        <span class="text-primary mb-3 d-block text-uppercase fw-semi-bold ls-xl">Featured In</span>
    ...
    <div class="py-8 py-lg-18">
      <div class="container">
        <div class="row mb-10 justify-content-center">
          <div class="col-lg-8 col-md-12 col-12 text-center">
            <!-- caption -->
            <span class="text-primary mb-3 d-block text-uppercase fw-semi-bold ls-xl">Why Learn with Geeks</span>
...
<div class="py-8 py-lg-16 bg-light-gradient-bottom">
              ...
              <div class="sliderSecond">
                <div class="item">
                  ...
                  <div class="card card-hover mb-3">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                      <h4 class="mb-2 text-truncate-line-2 "><a href="course-single.html" class="text-inherit">Gatsby JS:
                ...
                <div class="item">
                  <!-- Card -->
                  <div class="card card-hover mb-3">
                    <a href="course-single.html" class="card-img-top"><img src="../../assets/images/course/course-javascript.jpg" alt="" class="card-img-top rounded-top-md"></a>
                    <!-- Card Body -->
                    <div class="card-body">
                      <h4 class="mb-2 text-truncate-line-2 "><a href="course-single.html" class="text-inherit">Getting Started with JavaScript</a></h4>
                      <!-- List -->
                      <ul class="mb-3 list-inline">
                        <li class="list-inline-item"><i class="far fa-clock me-1"></i>2h 46m</li>
                        <li class="list-inline-item">
                ...
                <div class="item">
                  <!-- Card -->
                  <div class="card card-hover mb-3">
                    <a href="course-single.html" class="card-img-top"><img src="../../assets/images/course/course-wordpress.jpg" alt="" class="card-img-top rounded-top-md"></a>
                    <!-- Card Body -->
                    <div class="card-body">
              ...
              <div class="sliderThird">
                  ...
                  <div class="item">
                    ...
                    <div class="card  mb-4 card-hover">
                      <a href="#" class="card-img-top"><img src="../../assets/images/course/course-javascript.jpg" alt="" class="card-img-top rounded-top-md"></a>
                      <!-- Card body -->
                      <div class="card-body">
 ...
 <!-- row -->
      <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
          ...
          <div class="card mb-4 card-hover">
             <!-- img -->
            <div class="card-img-top">
              <img src="../../assets/images/instructor/instructor-img-2.jpg" alt="" class="rounded-top-md img-fluid">
            </div>
             <!-- card body -->
            <div class="card-body">
              <h3 class="mb-0 fw-semi-bold"><a href="#" class="text-inherit">Esther Howard</a></h3>
              ...
              <div class="lh-1  d-flex justify-content-between">
                ...
                <div>
                  <span class="fs-6 text-muted"><span class="text-dark">5,128</span> Students</span></div>
                <div>
                  <span class="fs-6 text-muted"><span class="text-dark">5</span> Course</span></div>
              </div>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
          ...
          <div class="card mb-4 card-hover">
             <!-- img -->
            <div class="card-img-top">
              <img src="../../assets/images/instructor/instructor-img-3.jpg" alt="" class="rounded-top-md img-fluid">
            </div>
             <!-- card body -->
            <div class="card-body">
              ...
              <div class="lh-1  d-flex justify-content-between">
                ...
                <div>
                  <span class="fs-6 text-muted"><span class="text-dark">7,423</span> Students</span></div>
                <div>
                  <span class="fs-6 text-muted"><span class="text-dark">8</span> Course</span></div>
              </div>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 d-lg-none d-xl-block">
          ...
          <div class="card mb-4 card-hover">
             <!-- img -->
            <div class="card-img-top">
              <img src="../../assets/images/instructor/instructor-img-4.jpg" alt="" class="rounded-top-md img-fluid">
            </div>
             <!-- card body -->
            <div class="card-body">
              ...
              <div class="lh-1  d-flex justify-content-between">
                ...
                <div>
                  <span class="fs-6 text-muted"><span class="text-dark">3,896</span> Students</span></div>
                <div>
                  <span class="fs-6 text-muted"><span class="text-dark">5</span> Course</span></div>
              </div>
            </div>
            ...
            <div class="card border shadow-none">
              ...
              <div class="card-body p-5">
                <div class="mb-2">
                  ...
                  <!-- para -->
                <p class="lead text-dark font-italic fw-medium mb-0">"Orci varius natoque penatibus et magnis dis parturient montes,
            ...
            <div class="card border shadow-none">
              ...
              <div class="card-body p-5">
                <div class="mb-2">
                  ...
                  <!-- para -->
                <p class="lead text-dark font-italic fw-medium mb-0">"Sed pretium risus magna, ac efficitur nunc rutrum imperdiet. Vivamus sed ante sed mi fermentum tempus. Nullam finibus augue eget felis efficitur semper."</p>
              </div>
                <!-- card footer -->
              <div class="card-footer px-5 py-4">
                <div class="d-flex align-items-center">
            ...
            <div class="card border shadow-none">
              ...
              <div class="card-body p-5">
                <div class="mb-2">
                  ...
                  <!-- para -->
                <p class="lead text-dark font-italic fw-medium mb-0">"Morbi quis posuere lacus. Morbi et metus sit amet tellus dapibus aliquam. Morbi consectetur magna vel turpis lobortis lorem iopsum dolor sit commodo."</p>
              </div>
                <!-- card footer -->
              <div class="card-footer px-5 py-4">
                <div class="d-flex align-items-center">
            ...
            <div class="card border shadow-none">
              ...
              <div class="card-body p-5">
                <div class="mb-2">
                  ...
                  <!-- para -->
                <p class="lead text-dark font-italic fw-medium mb-0">" Curabitur sollicitudin mi et sagittis egestas. Curabitur pellentesque nibh id enim hendrerit, at mollis neque rutrum. Sed nibh velit, tristique et dolor vitae."</p>
              </div>
                <!-- card footer -->
              <div class="card-footer px-5 py-4">
                <div class="d-flex align-items-center">
            ...
            <div class="card border shadow-none">
              ...
              <div class="card-body p-5">
                <div class="mb-2">
                  ...
                  <!-- para -->
                <p class="lead text-dark font-italic fw-medium mb-0">"Vestibulum in lobortis purus. Quisque sem turpis, hendrerit quis lacinia nec, rutrum nec velit. Nullam lobortis rhoncus tincidunt lorem ispun dnascetur ridiculus mus. "</p>
              </div>
                <!-- card footer -->
              <div class="card-footer px-5 py-4">
                <div class="d-flex align-items-center">
  ...
  <!-- para -->
                <p class="lead text-dark font-italic fw-medium mb-0">"Praesent sit amet ornare magna, vitae consequat arcu. Vestibulum at dictum erat, a fringilla ante. Nam et nibh ut nunc rutrum suscipit quis non neque. Nulla facilisi."</p>
              </div>
              <div class="card-footer px-5 py-4">
                <div class="d-flex align-items-center">
...
<!-- Mirrored from codescandy.com/geeks-bootstrap-5/pages/landings/landing-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jul 2021 14:53:49 GMT -->
</html>